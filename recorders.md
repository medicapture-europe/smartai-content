...
* The embedded operating system (OS) is under complete control of the manufacturer.

**Body colors:** MVR400, MVR409, MVR420, MVR435, MVR450, MVR460 body color is silver grey. MVR436, MTR133, MTR156 body color is black, and MTR133W, MTR156W are white.

### Model Summary

| Model | Description |
| --- | --- |
| **MVR400** (MVR Lite) | Cost-effective medical video recorder |
| **MVR409** (MVR Pro) | Premium medical video recorder with a built-in touchscreen monitor, allowing stand-alone operation |
| **MVR420** (MVR) | Full-featured medical video recorder |
| **MVR435** | Full-featured medical video recorder 4K60 |
| **MVR436** | Full-featured medical video recorder 4K60 |
| **MVR450** | Premium 4K60 medical video recorder with 12G SDI and other extended video input options |
| **MVR460** | Premium 4K60 medical video recorder with built-in 7-inch touch screen, with 12G SDI and other extended video input options |
| **MTR133** | Medical video recorder integrated into a touch-screen monitor (13.3") |
| **MTR156** | Medical video recorder integrated into a touch-screen monitor (15.6") |

## Common Specifications

Parameters and specifications common to all models of the MVR and MTR-series devices:

| Specification Parameter | Value, common to all models of MVR and MTR-series |
| --- | --- |
| Device type | Medical video recorder |
| Functional summary | Record video with audio sound and still images in ultra/high definition from medical video sources to USB storage, Internal storage, or Network storage; review, manage and edit images and videos; create and print reports; send recordings to NAS or PACS. |
| Device grade | Medical grade Class 1 Medical Device |
| Classification | Class 1 Device |
| GMDN code (Global Medical Device Nomenclature) | 18034 |
| European Medical Device Nomenclature EMDN code | 18034 |
| Intended Use | Record video and images from a variety of medical imaging systems |
...
| Storage and Operation Air Pressure Range, hPa | 700 to 1060 |
| Certification and compliance — Medical Equipment Safety | EN 60601-1:2006 + A1:2013 + A12:2014, UL, MDR 2017/745 EU |
| Certification and compliance — EMC | EN 60601-1-2:2015, FCC Part 15B Class B |
| Certification and compliance — Restriction of hazardous substances | EN IEC 63000:2018, WEEE |
| Certification for Radio Equipment — European Union | RED 2014/53/EU |
| Certification for Radio Equipment — Argentina | RAMATEL C-28771 |
| Certification for Radio Equipment — Costa Rica | SUTEL 08645-SUTEL-DGC-2022 |
| Certification for Radio Equipment — Paraguay | CONATEL NR: 2022-10-I-0628 |
| Other certification and compliance standards | IEC 61140:2016, (2014/35/EU) Low Voltage Directive, UKCA |
| Data protection | Medicapture has no access to stored data and to PHI (Protected Health Information) |
| Operation noise | Silent, fanless |
| Standard content of the Package Box (included accessories) | Recorder device, USB flash drive (except for MTR models), HDMI cable 2 meters, Split Remote Cable Adapter, Power Cord, 4 Rubber Feet, User Guide (English), HDMI to DVI adapter |
| USB ports at rear panel | 2x USB3.0 type A, for USB storage or HID devices, maximum combined output power 5V 2A |
| Remote port at rear panel | Port type: 3-pin 3.5 mm phone jack. Port functions: triggers for image capturing and video recording, footswitches or normally-open switch contacts; use Split Remote Cable Adapter (included) to connect 2 foot pedals |
| HDMI output port at rear panel | Port type: HDMI-A. Port function: video output for the user interface operation and recordings review. Supports connected HDMI monitors with resolution up to 4K UHD 3840x2160 |
...
| Package box material | Carton |
| Master pack material | Carton |
| Disposal Method | Use local regulations for proper disposal |
| Product life time, years | 3 |
| Product shelf life, years | 3 |
...
| Bonus warranty | 2 months of warranty extension after online product registration |
| Extended warranty | 3-year extended warranty is available on demand |
| Price | Contact MediCapture for pricing |

## Model-Specific Specifications

Parameters and specifications that differ between device models of the MVR and MTR series:

| Specification Parameter | MVR400 | MVR409 | MVR420 | MVR435 | MVR436 | MVR450 | MVR460 | MTR133 | MTR156 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Model name | MVR Lite | MVR Pro | MVR | MVR435 | MVR436 | MVR450 | MVR460 | MTR133 | MTR156 |
| Device description | Cost-effective medical video recorder | Premium medical video recorder with built-in touchscreen monitor, allowing stand-alone operation | Full featured medical video recorder | Full featured medical video recorder 4K60 | Full featured medical video recorder 4K60 | Premium 4K60 medical video recorder with 12G SDI and other extended video input options | Premium 4K60 medical video recorder with built-in 7-inch touch screen, with 12G SDI and other extended video input options | Medical video recorder integrated into a touch screen monitor | Medical video recorder integrated into a touch screen monitor |
...
| Fuse | 2 pcs of T1AH 250V | 2 pcs of T1AH 250V | 2 pcs of T1AH 250V | Internal, non-serviceable | Internal, non-serviceable | T2AH 250V x 2 pcs | T2AH 250V x 2 pcs | Internal, non-serviceable | Internal, non-serviceable |
...
| Headset audio port at rear panel | 4-pin 3.5 mm phone jack | 4-pin 3.5 mm phone jack | 4-pin 3.5 mm phone jack | Headphone: 3-pin 3.5 mm phone jack; Microphone: 1-pin 3.5 mm mono phone jack | Headphone: 3-pin 3.5 mm phone jack; Microphone: 1-pin 3.5 mm mono phone jack | Headphone: 3-pin 3.5 mm phone jack; Microphone: 1-pin 3.5 mm mono phone jack | Headphone: 3-pin 3.5 mm phone jack; Microphone: 1-pin 3.5 mm mono phone jack | Headphone: 3-pin 3.5 mm phone jack; Microphone: 1-pin 3.5 mm mono phone jack | Headphone: 3-pin 3.5 mm phone jack; Microphone: 1-pin 3.5 mm mono phone jack |
...
| USB port at front panel | USB3.0 type A, for USB storage, max output power 5V 0.9A | USB3.0 type A, for USB storage, max output power 5V 0.9A | USB3.0 type A, for USB storage, max output power 5V 0.9A | USB3.0 type A, for USB storage, max output power 5V 0.9A | None | USB3.0 type A, for USB storage, max output power 5V 2A | USB3.0 type A, for USB storage, max output power 5V 2A | None | None |
...
| SMA RF connectors for WiFi/BT antennas at rear panel | None | 2 | 2 | None | None | None | None | None | None |
| HDMI type A video input ports at rear panel | 2 | 2 | 2 | 1 | 1 | 2 | 2 | 1 | 1 |
| USB Type C port at rear panel | Not for use | Not for use | Not for use | USB3.0, supports DP video output up to 4Kp60 | USB3.0, supports DP video output up to 4Kp60 | USB3.0, supports DP video output up to 4Kp60 | USB3.0, supports DP video output up to 4Kp60 | USB3.0, supports DP video output up to 4Kp60 | USB3.0, supports DP video output up to 4Kp60 |
...
The device's specified cleaning and disinfection method (see Common Specifications above) is: **soft cloth moistened with ethanol 75%**. No further dedicated disinfection/disinfectant guidance section was found on the source page beyond this specification-table entry; consult the printed Instructions for Use (IFU) that ships with the device for any additional cleaning guidance.

## MVR Error Messages

A dedicated "MVR Error Messages — Support Reference" table (error codes/messages with explanations) could not be located on the live knowledge-base page at the time of this extraction. Error/status messages that *are* documented are included in context throughout this document — for example the PACS upload error messages under **Activation Keys > AKDICOM > PACS upload error troubleshooting**, the LDAP error messages under **Advanced Features > Remote LDAP Authentication**, and the Remote Configuration troubleshooting note under **Networking > Remote Access and Remote Configuration**. For a complete error-code reference, contact MediCapture support at [https://medicapture.com/support/](https://medicapture.com/support/).
